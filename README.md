# PyTorch-ENet
This is a restructured version of [``PyTorch-ENet``](https://github.com/davidtvs/PyTorch-ENet/) for the Control Engineering and Image Processing Lab.
...
This implementation has been tested on the CamVid dataset. Currently, a pre-trained version of the model trained in CamVid and Cityscapes is available [here](https://github.com/davidtvs/PyTorch-ENet/tree/master/save).
...
- [``runner.py``](https://github.com/davidtvs/PyTorch-ENet/blob/master/train.py): Defines the ``Runner`` class which is responsible for training the model.
